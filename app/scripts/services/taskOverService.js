...
angular.module('ZrsmWorker')
    .factory('taskOverService',function($cookieStore,$ionicPopup,$cookies,$http,$q,API_CONFIG,API_CONFIG_UTIL){
        var storageproducttaskdone = function(params) {
            var api = API_CONFIG.defaultPath + '/storageproducttaskdone';

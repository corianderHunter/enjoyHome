...
angular.module('ZrsmWorker')
    .factory('scanListService',function($cookieStore,$ionicPopup,$cookies,$http,$q,API_CONFIG,API_CONFIG_UTIL){
        var searchstocks = function(val) {
            var api = API_CONFIG.defaultPath + '/searchstocks';
